...
# "ACI_Ahmad_246_Aci": "/h/ahmad/SynthDataGen_v2/Synthetic_Data_Gen/data/eval_results/cont_eval/ablations/ACI_Ahmad_246_Aci_2025-02-08.csv",
models_to_get_scores2= { 
...
def main():
        ...
        for model_name, data_path in models_to_get_scores2.items():
