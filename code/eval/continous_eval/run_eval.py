...
def main():
    ...
    evaluator.save_model_output_to_csv(dial_summary_pairs = dial_summary_pairs, name= "aci_trained_model")
    eval_metrics= evaluator.get_automatic_eval_scores(dial_summary_pairs= dial_summary_pairs)
    evaluator.save_eval_metrics_to_csv(eval_metrics= eval_metrics, metrics_filename= "aci_trained_model")
