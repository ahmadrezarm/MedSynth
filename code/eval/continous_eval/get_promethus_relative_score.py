...
def main():
        get_and_save_prometheus_preference_scores(model_A_name= "base_model",
                                                  model_B_name= "aci_train_model_v2",
                                                  ...
                                                  model_B_dial_summary_pairs_path= "/h/ahmad/SynthDataGen/Synthetic_Data_Gen/data/eval_results/cont_eval/aci_train_model_v2_2024-05-12.csv")
