...
""" 
def main():
        get_and_save_prometheus_preference_scores_GPT(model_A_name= "ACI_Ahmad57_and_Aci",
                                                  model_B_name= "Primock57_and_Aci",
...
def main():
        Note2Dial_get_and_save_prometheus_preference_scores_GPT(model_A_name= "N2D_ACI_Ahmad57_Only",
                                                  ...
                                                  model_B_dial_summary_pairs_path= "/h/ahmad/SynthDataGen/Synthetic_Data_Gen/data/eval_results/cont_eval/N2D_ACI_Primock57_Only_2024-12-14.csv",
                                                  test_data_path= constants.Aci_test_path) #
